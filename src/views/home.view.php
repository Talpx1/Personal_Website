    ...
    <main class="text-center flex flex-col content-center items-center justify-center grow">
        <div class="flex flex-col content-center gap-28 grow justify-center">
            <div class="flex flex-col justify-center gap-5">
                <h1 class="font-bold whitespace-nowrap text-2xl lg:text-4xl tracking-widest"><?= t("hi_im_simone", '<span class="font-accent text-4xl lg:text-6xl rainbow-underline px-1">') ?> :)</h1>
                <h2 class="font-bold whitespace-nowrap text-xl lg:text-2xl tracking-widest"><?= t('a_fullstack_developer', '<span class="font-accent text-2xl lg:text-4xl rainbow-underline px-1">') ?></h2>
            </div>
