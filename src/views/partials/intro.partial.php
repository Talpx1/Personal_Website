<section class="grid place-content-center text-dark dark:text-light  bg-light dark:bg-dark font-primary place-items-center gap-8 fixed top-0 left-0 z-40 w-full border-8 border-dark dark:border-light border-solid" id="intro">
