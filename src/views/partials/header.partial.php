<header class="flex flex-row justify-between items-center py-5 px-5 lg:px-20">    
    ...
    <div class="flex flex-row gap-5 items-center text-dark dark:text-light">
        <a href="/<?= app()->alternateLocale() . app()->currentRoute() ?>" class='uppercase'><?= app()->alternateLocale() ?></a>
        <button type="button" id="toggle-dark-mode" class="bg-transparent p-0 m-0 border-0" aria-label="<?= t('toggle_dark_mode') ?>" title="<?= t('toggle_dark_mode') ?>">
